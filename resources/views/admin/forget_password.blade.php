...
<html lang="en">
 ...
 @csrf
                                            ...
                                            <div class="mb-3">
                                                <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">email password reset</button>
                                            </div>
</form>
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div class="flex-grow-1 ms-3 mb-4">
                                                                    <h5 class="font-size-18 text-white">Dani Pratama
                                                                    </h5>
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            ...
                                                            <img src="{{asset('backend/assets/images/users/avatar-1.jpg')}}" class="avatar-md img-fluid rounded-circle" alt="...">
                                                                <div class="flex-1 ms-3 mb-4">
                                                                    <h5 class="font-size-18 text-white">Dani Pratama</h5>
